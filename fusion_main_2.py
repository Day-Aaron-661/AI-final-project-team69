...
from fusion_model_2 import (LateFusionModel , validate , train)  
import torch
...
#     fusion_model.train()
#     total_loss = 0
#     train_loss = train( fusion_model , train_loader ,  criterion , optimizer , device)
#     val_loss = validate( fusion_model , val_loader , criterion , device )

#     train_losses.append(train_loss)
#     val_losses.append(val_loss)
#     print ( "Training .......... epoch =" , epoch , 
#             " finished "  "train_loss =",train_loss, " , val_loss =" , val_loss )
